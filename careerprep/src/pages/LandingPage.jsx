    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
     <nav className="container mx-auto px-4 sm:px-6 py-4 sm:py-6">
      ...
      <div className="flex-grow relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-green-50 via-gray-50 to-gray-100"></div>
        
        {/* Decorative Elements */}
        <div className="absolute top-0 left-0 w-96 h-96 bg-green-500 rounded-full opacity-20 -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-green-600 rounded-full opacity-10 translate-x-1/3 translate-y-1/3"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center max-w-7xl mx-auto">
            ...
            <div className="order-2 md:order-1">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                ...
                <br />
                <span className="text-green-600">Land Your Dream Job</span>
              </h1>
              ...
              <button 
                onClick={() => setShowModal('register')}
                className="px-8 py-4 bg-green-600 text-white text-lg rounded-lg font-semibold hover:bg-green-700 transition shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
                Start Building Free
              </button>
            </div>

            {/* Right Content - Custom Image Area */}
            <div className="order-1 md:order-2 relative">
              <div className="relative h-96 sm:h-[500px] flex items-center justify-center">
                {/* Background Image Layer - Replace with your background image path */}
                <div 
                  className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-100 rounded-3xl"
                  style={{
